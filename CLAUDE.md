Werk elke stap die je doet bij in JOURNAL.md
...
Iedere stap wordt gelogged in JOURNAL.md en voeg bij iedere stap ook het tijdstip toe
Vink alle items die gebouwd zijn af in requirements.md

Als er een nieuwe versie wordt gegenereerd van een reeds bestaand document, hoog dan het versienummer op!

Maak ook een file URL.md inclusief login credentials op het moment dat we een deploy hebben gedaan.

Mocht je deployen op Azure, kijk eerst of het via APP Service kan, container app service is mogelijk geblokkeerd!
